...
using System;
public class CaltropsZone : MonoBehaviour
{
    ...
    IEnumerator DOTRoutine()
    {
        ...
        while (elapsed < duration)
        {
            ...
            foreach (Collider enemy in enemies)
            {
                ...
                vampireMovement movement = enemy.GetComponent<vampireMovement>();
                originalSpeed = movement.moveSpeed;
                if (movement != null)
                {
                    movement.moveSpeed *= .25f;
                    movement.moveSpeed = Mathf.Clamp(movement.moveSpeed, 1.0f, 3);
                }
            ...
            {
                Color faded = new Color(0f, 0.0f, 0f, alpha);
        ...
        foreach (Renderer r in renderers)
        {
            ...
            for (int i = 0; i < r.materials.Length; i++)
            {
                if (r.materials[i].HasProperty("_Color"))
                {
                    ...
                    r.materials[i].color = new Color(0f, 0f, 0f);
                }
            }
    ...
    void DrawCircle(Vector3 center)
    {
        ...
        circleRenderer.startColor = new Color(0f, 0.0f, 0f, 0.9f);
        circleRenderer.endColor = new Color(0f, 0.0f, 0f, 0.9f);
